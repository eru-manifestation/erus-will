...
(deffunction cast (?cast)
    (bind ?*cast-activated* ?cast)
)

; FASES REGULARES
(defrule cast-begin-turn (declare (salience ?*universal-rules-salience*))
...
(defrule cast-untap-phase (declare (salience ?*universal-rules-salience*))
...
(defrule cast-organization-phase (declare (salience ?*universal-rules-salience*))
...
(defrule cast-organization-actions (declare (salience ?*universal-rules-salience*))
...
(defrule cast-long-events-phase (declare (salience ?*universal-rules-salience*))
...
(defrule cast-long-events-r-discard (declare (salience ?*universal-rules-salience*))
...
(defrule cast-long-events-play (declare (salience ?*universal-rules-salience*))
...
(defrule cast-long-events-a-discard (declare (salience ?*universal-rules-salience*))
...
(defrule cast-movement-phase (declare (salience ?*universal-rules-salience*))
...
; FASES EVENTUALES
(defrule cast-reveal-move (declare (salience ?*universal-rules-salience*))
