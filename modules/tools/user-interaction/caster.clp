...
; FASES REGULARES
(defrule TOOLS::cast-begin-turn 
    (declare (auto-focus TRUE) (salience ?*universal-rules-salience*))
...
(defrule TOOLS::cast-untap-phase 
    (declare (auto-focus TRUE) (salience ?*universal-rules-salience*))
...
(defrule TOOLS::cast-organization-phase 
    (declare (auto-focus TRUE) (salience ?*universal-rules-salience*))
...
(defrule TOOLS::cast-organization-actions 
    (declare (auto-focus TRUE) (salience ?*universal-rules-salience*))
...
(defrule TOOLS::cast-long-events-phase 
    (declare (auto-focus TRUE) (salience ?*universal-rules-salience*))
...
(defrule TOOLS::cast-long-events-r-discard 
    (declare (auto-focus TRUE) (salience ?*universal-rules-salience*))
...
(defrule TOOLS::cast-long-events-play 
    (declare (auto-focus TRUE) (salience ?*universal-rules-salience*))
...
(defrule TOOLS::cast-long-events-a-discard 
    (declare (auto-focus TRUE) (salience ?*universal-rules-salience*))
...
(defrule TOOLS::cast-movement-phase 
    (declare (auto-focus TRUE) (salience ?*universal-rules-salience*))
...
; FASES EVENTUALES
(defrule TOOLS::cast-reveal-move 
    (declare (auto-focus TRUE) (salience ?*universal-rules-salience*))
