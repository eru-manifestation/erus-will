...
; (defrule MAIN::faction-play-dices-data-item-population (declare (auto-focus TRUE) (salience ?*universal-rules*))
;     (logical
...
;     )
;     =>
;     (message Se crea el dices item por ?char y ?faction)
...
; (defrule MAIN::strikes-attackable-data-item-population (declare (auto-focus TRUE) (salience ?*universal-rules*))
;     (logical
;         (object (is-a E-select-strike) (type IN) (char ?char) (attackable ?attackable))
;     )
;     =>
;     (message Se crea el strike item por ?char para ?attackable)
...
; (defrule MAIN::dices-strike-data-item-population#tapped (declare (auto-focus TRUE) (salience ?*universal-rules*))
;     (logical
;         (object (is-a EP-strike) (name ?ep) (type ONGOING) (char ?char))
;         (object (is-a CHARACTER) (name ?char) (state TAPPED))
;     )
;     =>
;     (message Se crea el dices item por ?char para ?ep)
;     (make-instance (gen-name data-item) of data-item (target-slot dices) (target ?ep) (value -1))
; )


; INFO ITEM PARA DICES DE STRIKE
; (defrule MAIN::dices-strike-data-item-population#wounded (declare (auto-focus TRUE) (salience ?*universal-rules*))
;     (logical
;         (object (is-a EP-strike) (name ?ep) (type ONGOING) (char ?char))
...
; INFO ITEM PARA DICES DE STRIKE
; (defrule MAIN::dices-strike-data-item-population#additional (declare (auto-focus TRUE) (salience ?*universal-rules*))
;     (logical
;         (object (is-a EP-strike) (name ?ep) (type ONGOING) (char ?char))
;         (object (is-a EP-strike) (name ?ep1) (type OUT) (char ?char))
;     )
;     =>
;     (message Se crea el dices item por ?ep1 para ?ep)
;     (make-instance (gen-name data-item) of data-item (target-slot dices) (target ?ep) (value -1))
; )


; INFO ITEM PARA DICES DE STRIKE
; (defrule MAIN::dices-strike-data-item-population#hindered (declare (auto-focus TRUE) (salience ?*universal-rules*))
;     (logical
;         (object (is-a EP-strike) (name ?ep) (type ONGOING) (hindered TRUE))
;     )
;     =>
;     (message Se crea el dices item por hindered para ?ep)
