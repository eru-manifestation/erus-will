...
(defclass MAIN::RIVENDELL (is-a HAVEN)
    ...
    (multislot site-pathA (source composite) (default [lorien] ))
    (multislot site-pathB (source composite) (default [grey-havens]))
...
(defclass MAIN::GREY-HAVENS (is-a HAVEN)
    ...
    (multislot site-pathA (source composite) (default [rivendell] ))
    (multislot site-pathB (source composite) (default [edhellond]))
